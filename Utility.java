...
public class Utility {
	...
	// public static void udp_send (RDTSegment seg, DatagramSocket socket, InetAddress ip, int port)
	...
	public static void udp_send (RDTSegment seg, DatagramSocket socket,
		...
		// int ackNum_ = Utility.byteToInt(payload, 4);
		// System.out.printf("ackNum is: %d",ackNum_);
